        ...
        <div class="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
            <div>
                ...
                <ul class="text-gray-300">
                    ...
                    @can('admin.banners.index')
                        ...
                        <li class="mb-4">
                            <a href="{{ route('admin.banners.index') }}" class=" hover:underline">Banner</a>
                        </li>
                        <li class="mb-4">
            ...
            <div>
                ...
                <ul class="text-gray-300">
                    @can('superadmin.users.index')
                        <li class="mb-4">
                            <a href="{{ route('superadmin.users.index') }}" class=" hover:underline">Usuarios</a>
                        </li>
                    @endcan

                    @can('admin.banners.index')
                        <li class="mb-4">
                            <a href="{{ route('admin.modules.index') }}" class="hover:underline">Módulos</a>
                        </li>
                        <li class="mb-4">
                            <a href="{{ route('admin.stations.index') }}" class="hover:underline">Estaciones meteorológicas</a>
                        </li>
                        <li class="mb-4">
                            <a href="{{ route('admin.documents.index') }}" class="hover:underline">Documentos</a>
                        </li>
                    @endcan
                </ul>
            </div>
