<div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-gray-700">
        <div class="h max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            ...
            <p class="text-center">Complete esta información para editar un documento</p>
        </div>
        <div class="bg-white shadow-xl rounded-lg p-4">
            <div class="grid grid-cols-2 gap-2 mb-4">
                ...
                <div class="mb-4">
                    ...
                    <select class="form-control w-5/6 rounded-lg p-2" name="authors"
                        wire:model="editForm.author_id">
                        <option value="" disabled selected>Seleccione un Autor</option>
                        @foreach ($authors as $author)
                            <option value="{{ $author->id }}">{{ $author->name }} {{ $author->lastname }}</option>
                        @endforeach
                    </select>
                    <x-jet-input-error for="editForm.author_id" />
                ...
                <div class="mb-4">
                    ...
                    <x-jet-input type="date" wire:model="editForm.date_publication" class="w-full" />
                    <x-jet-input-error for="editForm.date_publication" />
                </div>
