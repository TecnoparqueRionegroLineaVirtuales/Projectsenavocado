<div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 text-gray-700">
        <div class="h max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            ...
            <p class="text-center">Complete esta información para agregar una estación</p>
        </div>
            ...
            <div class="grid grid-cols-2 gap-2 mb-4">
                ...
                <div class="mb-4">
                    ...
                    <select class="form-control w-full rounded-lg p-2" name="vereda"
                        wire:model="createForm.vereda_id">
                    ...
                    <x-jet-input-error for="createForm.vereda_id" />
                </div>

                {{-- Código --}}
                <div class="mb-4">
                    <x-jet-label value="Código" />
                    <x-jet-input type="text" wire:model="createForm.code" step=".01" class="w-full" />
                ...
                <div class="mb-4">
                    ...
                    <x-jet-input type="text" wire:model="createForm.latitude" class="w-full" />
                ...
                <div class="mb-4">
                    ...
                    <x-jet-input type="text" wire:model="createForm.longitude" class="w-full" />
